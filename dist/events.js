...
function start() {
    ...
    $("#subjects").on("click", ".edit", function () {
        ...
        bootbox.prompt("Pick a new name for your subject...", (result) => {
            if (result !== null) {
                const name = result;
    ...
    $("#notes").on("click", ".edit", function () {
        const id = $(this).data("edits");
        bootbox.prompt("Pick a new name for your note...", (result) => {
            if (result !== null) {
                const name = result;
